...
class IIDSimulation(object):
    ...
    def __init__(self, W, n=1000, method='linear', 
                 sem_type='gauss', noise_scale=1.0, noise_type : str = "gauss"):
        ...
        if method == 'linear':
            ...
            self.X = IIDSimulation._simulate_nonlinear_sem(
                    W, n, sem_type, noise_scale, noise_type)
    ...
    @staticmethod
    def _simulate_nonlinear_sem(W, n, sem_type, noise_scale, noise_type):
        """
        ...
        def _simulate_single_equation(X, scale):
            ...
            if noise_type == 'gauss':
                ...
                raise ValueError('Unknown noise type. In a non-linear model, \
                                 the options are as follows: gauss, exp, \
                                 gumbel, uniform, laplace.')
